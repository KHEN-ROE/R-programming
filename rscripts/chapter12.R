...
CrossTable(x = diamonds$color, y = diamonds$cut) #독립변수, 종속변수
...
CrossTable(x = diamonds$cut, 
           y = diamonds$color, chisq = TRUE) # p값이 25% 나온다. 가설 검증 실패. p는 5%이하여야 함.
