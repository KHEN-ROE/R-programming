...
drv <- JDBC("oracle.jdbc.driver.OracleDriver",
            "C:\\app\\SW\\product\\21c\\dbhomeXE\\jdbc\\lib\\ojdbc8.jar")

# 단계 2: 오라클 데이터베이스 연결
conn <- dbConnect(drv,
                  "jdbc:oracle:thin:@//127.0.0.1:1521/xe", "c##ken", "1234")
...
recode <- read.csv("C:/Rwork/Part-II/recode.csv", fileEncoding = 'euc-kr') #한글 코드 때메 에러남
...
# 단계 2: 특정 항목의 내용을 제외한 itemsets 수 발견
apr1 <- apriori(Adult,
